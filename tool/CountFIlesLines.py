...
### Parameters region
    ...
    src = "/home/devin/MyGit/MediaPipe_Hiar/MediaPipeAndroid/HiGestureAndroid/gesturesdk/src"
### Job region
    import subprocess
    cnt = 0
    files = traversFilesInDir(src)
    for i in files:
        if ".cc" in i or ".h" in i or ".java" in i:
            cmd = "wc -l " + i
